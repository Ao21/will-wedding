...
export class HeaderItemLeft {
    ...
    initShapes() {
        ...
        this.shapeArr.push(
            { name: 'BorderLeftHeader1', stroke: 2, path: `M140.1,23 57,94.4 57,${window.innerHeight}`},
            { name: 'BorderLeftHeader2', stroke: 3, path: `M48.5,${window.innerHeight} 48.5,87 142,8.5`},
            { name: 'BorderLeftHeader3', stroke: 2, path: `M30,${window.innerHeight}V104`},
            { name: 'BorderLeftHeader4', stroke: 2, path: `M20,${window.innerHeight}V106l0.4,0.4c7.8,7.9,12,8,19.3-0.8l0.4-0.4V${window.innerHeight}`},
            { name: 'BorderLeftHeader5', stroke: 2, path: `M380,23H105L26,88.2c1.1-0.4,2.3-0.6,3.5-0.6c5.6,0,10.2,4.2,10.7,9.8L40,42.2`},
            { name: 'BorderLeftHeader6', stroke: 5, path: `M420.7,10.2 78.4,9.9 10.5,67.1 10.5,${window.innerHeight}`},
            { name: 'BorderLeftHeader7', stroke: 2, path: `M455,1 113,1 1,95.1 1,${window.innerHeight}`},
        )
    }

...
import {
	TOP_BORDER_RIGHT_LEFT_1,
	TOP_BORDER_RIGHT_LEFT_2,
	TOP_BORDER_RIGHT_LEFT_3
} from './../core/utils/measure';
	...
	initShapes() {
		...
		this.shapeArr.push(
			...
			},
			{
				...
				stroke: 2,
				path:
					'M70,23h277l78.9,65.2c-1.1-0.4-2.3-0.6-3.5-0.6c-5.6,0-10.2,4.2-10.7,9.8l0.3-55.1'
			},
			{
			...
			},
			{
				...
				stroke: 5,
				path: `M${TOP_BORDER_RIGHT_LEFT_2},10.2 373.6,9.9 441.5,67.1 441.5,${window.innerHeight}`
			},
			{
				name: 'BorderRightHeader7',
				stroke: 2,
				path: `M${TOP_BORDER_RIGHT_LEFT_1},1 339,1 451,95.1 451,${window.innerHeight}`
			}
		);
	}

	public BorderRightHeader1() {
		const svg = new BorderRightHeader1();
	}
}

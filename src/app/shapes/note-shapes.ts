...
export class MusicNotes {
	...
	createHeaderShapes() {
		...
		// 95  - bar
		// 102 -- bottom
		const s = this.createHeaderShape(
			BORDER_TIME_DELAY + 5000,
			220,
			{ 'rand(75,115)': '95' },
			95,
			'MusicNote1'
		);
		const s2 = this.createHeaderShape(
			BORDER_TIME_DELAY + 5200,
			235,
			{ 'rand(75,115)': '102' },
			102,
			'MusicNote2'
		);
		const s3 = this.createHeaderShape(
			BORDER_TIME_DELAY + 5400,
			325,
			{ 'rand(75,115)': '85' },
			85,
			'MusicNote1'
		);
		const s4 = this.createHeaderShape(
			BORDER_TIME_DELAY + 5600,
			340,
			{ 'rand(75,115)': '95' },
			95,
			'MusicNote1'
		);
		const s5 = this.createHeaderShape(
			BORDER_TIME_DELAY + 5800,
			365,
			{ 'rand(75,115)': '75' },
			75,
			'MusicNote3'
		);
		const s6 = this.createHeaderShape(
			BORDER_TIME_DELAY + 6000,
			380,
			{ 'rand(75,115)': '100' },
			100,
			'MusicNote4'
	...
	configureOptions() {
		...
		const burst2 = new Burst(
			_.assign({}, SWIRL_OPTS, {
				children: _.assign({}, SWIRL_OPTS.children, {

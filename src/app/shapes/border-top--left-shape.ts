	...
	initShapes() {
		...
		this.shapeArr.push(
			...
			{ name: 'BorderLeftHeader3', stroke: 1.5, path: 'M7.9,67V17.1' },
			{
				...
				stroke: 1.5,
				path:
					'M4.9,0L4.7,61.1c0,0.2,0.2,0.3,0.3,0.1l2.7-4.1C7.9,57,8,57,8.1,57.1l2.7,4.1c0.1,0.1,0.3,0.1,0.3-0.1 L11,0'
			},
			...
			{ name: 'BorderLeftHeader8', stroke: 1.5, path: 'M17.1,7.8H67' },
			{
				...
				stroke: 2,
				path:
					'M0,10.9L61.1,11c0.2,0,0.3-0.2,0.1-0.3L57.1,8c-0.1-0.1-0.1-0.2,0-0.3l4.1-2.7c0.1-0.1,0.1-0.3-0.1-0.3 L0,4.8'
			},
